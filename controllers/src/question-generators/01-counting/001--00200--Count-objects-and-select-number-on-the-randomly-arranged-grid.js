// Count objects and select number on the randomly arranged grid
// How many objects are there? Count objects and select number on the randomly arranged number grid
// 1 <= count <= 9
