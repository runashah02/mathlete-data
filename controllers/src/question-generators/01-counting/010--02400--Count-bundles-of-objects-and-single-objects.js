// Count bundles of objects and single objects
// How many hundreds, tens and ones? Count bundles and fill in the blank with correct values for each type of bundles
...
function exerciseCustomCSS() {
  return `
      ...
      .cube-grid td {width: 8px; height: 8px; border: 2px solid #b7e7fb; background-color: transparent;}
  `;
}
